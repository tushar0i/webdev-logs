...
const TopBar = () => {
    return (<>
        <div className="flex justify-between px-8 py-3 bg-white shadow-lg/10">
            <div className="flex">
                <div className="text-2xl font-medium my-auto">
                    Payout
                </div>
                <div className=" flex pl-4 my-auto text-zinc-600 w-7.5 ">
                ...
                <div className="my-auto pl-1 text-sm  text-zinc-600 ">
                    How it work's 
                </div>
            </div>
            <div>
